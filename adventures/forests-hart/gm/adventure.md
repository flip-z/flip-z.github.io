...
The investigation should not simply reveal the solution. It gives the party enough pieces to reconstruct and attempt an old rite whose full meaning becomes clear during the finale.
...
## FH-02 — Taran Holt's Smithy

Taran is a practical skeptic. He recognizes that the Wolf's Tooth is forged cold iron and was deliberately shaped to mount on a haft. Its form resembles an obsolete regional hunting implement: the broad root remains exposed as a striking surface while the point can penetrate flesh.
...
Run a short three-part challenge. Use moderate DCs for the party's level and allow any justified skill.

1. **Reconstruct the design.** Crafting is primary; Society, Lore, Occultism, Religion, or similar knowledge can help interpret the old form.
2. **Prepare the components.** Crafting is primary; Athletics can assist with forge work and Survival can select and prepare the haft.
3. **Assemble and balance the weapon.** Crafting is primary; Thievery can handle precise fitting, while Athletics or relevant weapon expertise can help establish balance.

The weapon is never lost to failed rolls. Results determine time and finish:

- 3 successes: completed before supper and well balanced.
- 2 successes: completed before supper and functional but crude.
- 1 success: Taran must repair mistakes; completed late that evening.
- 0 successes: Taran finishes it overnight.
...
## FH-05 — Recruit a Bellkeeper

The shrine carvings establish that someone traditionally remained at the bell while the hunters left. The GM should not explicitly instruct the party to recruit a helper.
...
The bell **calls** the Hart but does not compel it to approach. This is the moment the old carvings become legible as procedure: the bellkeeper maintains the shrine while the hunters go after the Hart.

### Phase 1 — Pursuit

Use a modified PF2e Chase structure. The party tracks, pressures, and drives the Hart back toward the active shrine. Obstacles can include corrupted terrain, waterways, malformed vegetation, losing contact, and creatures moving in the Hart's wake.

Attack rolls, skills, spells, and appropriate equipment can all overcome obstacles.

Failures do not end the hunt. They increase **breach pressure**. Each failure represents the party falling farther behind the Hart and gives the corruption trailing it more opportunity to reach and interfere with the bellkeeper.

If the Hart was freed earlier, reacquiring it adds an additional obstacle.

### Phase 2 — Shrine and containment

The Hart can cross the active boundary because the rite specifically calls it home. Ordinary corrupted wildlife cannot cross while the bell is maintained.

When the Hart enters the aura, its accumulated corruption begins to slough away from it. The bell does **not** destroy that corruption. It drives it outward and suspends it visibly at the edge of the shrine's boundary.

The Hart itself cannot be killed normally while still heavily corrupted. The party's combat objective is to strip away or destroy its remaining **corruption layers** while protecting the bell. Represent these as targetable manifestations, growths, spiritual lesions, or encounter objectives attached to the Hart rather than ordinary HP damage to an immortal boss.

The Hart remains an active threat. It can charge, kick, reposition, attempt to escape the shrine, and use **Corruption Surge** to disrupt the bellkeeper. A surge can knock the bellkeeper away, stagger them, or otherwise interrupt the ringing.

When the bell stops, the boundary flickers. Suspended corruption begins pressing back inward and malformed creatures outside can breach the perimeter. Restoring the bell pushes the corruption outward again, but anything that crossed remains inside and must be dealt with.

Breach pressure from the chase determines the opening state. A party that arrives behind the Hart may find the bellkeeper already knocked away and one or more malformed creatures inside the boundary.

The core combat loop is:

**Maintain bell → strip corruption → Hart disrupts bell → boundary breaches → restore bell → contain the breach → continue stripping corruption.**

Recruiting a bellkeeper gives the full party freedom to pursue and fight until the bell is disrupted. Without one, a PC begins the encounter committed to maintaining the bell.

### Phase 3 — Complete the Passage

As the final corruption layer is removed, the Hart becomes visibly ordinary, exhausted, and mortal inside the shrine. The accumulated corruption remains suspended around the boundary, held away only by the ringing bell.
...
Removing the Tooth causes the aura to begin fading, creating immediate urgency. If the Hart dies before the suspended corruption returns, there is no living vessel for it to reclaim. The corruption collapses, withers, or burns itself out against the failing boundary and the Hart dies normally.

If the party refuses to kill the exposed Hart, the bell can contain the corruption only temporarily. When the ringing ends, the suspended corruption returns to the Hart and the cycle begins again. This should be visibly and mechanically apparent rather than explained only by the GM.

## Resolution

With the Hart dead, Coedmyr does not become instantly lush. The active imbalance ends. Water, wildlife, and vegetation can begin returning to ordinary natural cycles over time.

The bellkeeper is at genuine risk during the finale. Ewan can survive or die based on play; his death should never be scripted. If he dies, returning his body to Coedmyr gives the victory an immediate human cost. If he survives, he becomes one of the few villagers to have directly witnessed the meaning of the old rite.

If the party is defeated, abandons the rite, or repeatedly leaves the Hart alive after understanding the consequence, the corruption continues to worsen and can become a larger regional threat.
