...
The old tradition joined reverence with stewardship. It also maintained a practical religious keeper or warden whose responsibilities included shrines, trails, hunts, harvest limits, stewardship work, and continuity of ritual knowledge.

As the forest declined, pilgrimage became increasingly concentrated around pleasant and accessible practices. The overlook survived through meditation, exercise, prayer, views, picnics, and simplified ceremony while the harder forest traditions and practical keeper office disappeared. Sera preserves the surviving heritage sincerely, but not the complete working institution.

## Preparation model

- **FH-00 — Arrival and first investigation:** Elara supplies symptoms and local history. The spring can provide a mundane explanation for the water problem without explaining the wider outbreak. A dusk incursion provides stronger evidence and can introduce Ewan if the party has not already sought him out.
- **FH-01 — Maelin Tor and Nessa:** gain old stewardship context, broader four-spirit folklore, fragments of the lost keeper office, and recover the Wolf's Tooth. Their conversation should also contain irrelevant stories, old customs, and translation disagreements.
...
- **FH-03 — Shrine and overlook:** discover the bell, weak aura, recognizable keeper role, old hunt records, and the surviving spirit trail. If the party has not meaningfully entered the forest, the trail can surface abnormal cries, malformed tracks, or abandoned trapping infrastructure that intersects Ewan's existing trap line.
- **FH-04 — Ewan's trap line:** follow a progression from neglected traps to a severely malformed doe, increasingly contradictory natural processes, and finally the trapped Hart at the center of the strongest disturbance.
- **FH-05 — Bellkeeper:** once the party discovers that the correct bell response requires sustained ringing, the practical keeper role should be obvious. Ewan, Sera, Nessa, Taran, another villager, or a PC can fill it.
...
Old carvings and records establish a recognizable keeper or cantor who remains at a ritual site while hunters depart. Once the Wolf's Tooth produces the correct response, sustained ringing makes the practical requirement explicit.

Recruitment remains optional. Ewan offers forest experience and personal responsibility; Sera offers ritual familiarity; Nessa offers archaic-language access; Taran offers physical dependability. Without a helper, one PC remains at the shrine.

## Finale

**Trigger:** Repeatedly strike the shrine bell with the reconstructed Wolf's Tooth.

**Pursuit:** The bell calls the Hart toward the shrine but does not compel its route. The party must keep contact and drive it along the old hunt path. Failed obstacles increase **breach pressure**, representing disordered problems reaching the keeper first.
...
flowchart TD
    ...
    SAGE["FH-01 Maelin + Nessa<br/>old context + Wolf's Tooth"]
    SMITH["FH-02 Taran Holt<br/>identify + reconstruct implement"]
    SHRINE["FH-03 Shrine / overlook<br/>bell + keeper + hunt records"]
    HUNTER["FH-04 Forest / trap line<br/>locate Hart"]
...
For each simulated path, vary branch order and allow personality-driven choices, failed checks, missed clues, incorrect hypotheses, early Hart release, skipped NPCs, and failure to recruit a bellkeeper. Record what the party currently believes, what options they know exist, what action they are most likely to take next, whether missing content creates an arbitrary dead end, and how each preparation changes the finale.
